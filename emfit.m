...
%EM-algorithm: estimation under no constraints
%Input: D: data
...
function [thetahat sigmahat qhat   lvec]=emfit(D,theta0,sigma0,q0,maxiter,tol)
        ...
        for loop=1:maxiter
            ...
            [thetahat tempval]=quadprog(H,-f,[],[],Aeq1,zeros(size(Aeq1,1),1),zeros(dimq,1),[],[],options);, 
